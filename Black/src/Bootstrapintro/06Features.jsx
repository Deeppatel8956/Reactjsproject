...
<div className="container" data-aos="fade-up">
  ...
  <div className="row">
    ...
    <div className="col-lg-6">
      <img src="src/Bootstrapintro/img/features.png" className="img-fluid" alt=""/>
    </div>
  ...
  <div className="row feture-tabs" data-aos="fade-up">
    ...
    <div className="col-lg-6">
      <img src="src/Bootstrapintro/img/features-2.png" className="img-fluid" alt=""/>
    </div>
  ...
  <div className="row feature-icons" data-aos="fade-up">
    ...
    <div className="row">
      ...
      <div className="col-xl-4 text-center" data-aos="fade-right" data-aos-delay="100">
        <img src="src/Bootstrapintro/img/features-3.png" className="img-fluid p-4" alt=""/>
      </div>
