  ...
  <div className="row">
    ...
    <div className="col-lg-4">
      <div className="post-box">
        <div className="post-img"><img src="src/Bootstrapintro/img/blog/blog-1.jpg" className="img-fluid" alt=""/></div>
    ...
    <div className="col-lg-4">
      <div className="post-box">
        <div className="post-img"><img src="src/Bootstrapintro/img/blog/blog-2.jpg" className="img-fluid" alt=""/></div>
    ...
    <div className="col-lg-4">
      <div className="post-box">
        <div className="post-img"><img src="src/Bootstrapintro/img/blog/blog-3.jpg" className="img-fluid" alt=""/></div>
